...
// 付録A：報道の呼び方（丸ごと一致で引く）
const ALIASES = {
  // FRB・日本銀行・日銀は世界に1つ（sekai_chizu_naoshi_shiji.md 4）。財務省は足さない
  // v20.24：米連邦政府（「米連邦政府の調達枠」がカナダ国内に化けていた）。GBR は前の行のコメントの中に入っていて表に入っていなかった
  USA: ['米国', '米', 'アメリカ', '合衆国', '米国政府', 'FRB', '米連邦政府'], CHN: ['中国'], JPN: ['日本', '日本国', '日本銀行', '日銀'], GBR: ['英国', 'イギリス'],
  ...
  SYR: ['シリア'],   // v20.24：正式名「シリア・アラブ共和国」しか無く、「シリアの発電事業」がサウジ国内に化けていた
};
...
const SLOTS = {
  ...
  REG: { label: '地域', exact: ['EU', '欧州連合', '欧州委員会', 'ECB', '欧州中央銀行', 'ユーロ圏'], contains: ['同盟国', '加盟国', '産油国', '諸国', '各国', '欧州', 'アジア'] },   // 欧州・アジアは v20.20
